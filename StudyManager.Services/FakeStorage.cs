...
{
    internal static readonly IReadOnlyList<SubjectData> Subjects;
    internal static readonly IReadOnlyList<LessonData> Lessons;
    ...
    static FakeStorage()
    {
        ...
        Subjects = new List<SubjectData> { subject1, subject2, subject3 };
